/*
 	...
 	A copy of JF 7's example class, but in the default package.
...
public class CardOld
{
	...
	// -----------------------------------------------------------------
	public CardOld(int faceValue, int suitValue)
	{
		face = faceValue;
		setFaceName();
	...
	// -----------------------------------------------------------------
	public boolean isHigherThan(CardOld card2, boolean aceHigh)
	{
	...
	// -----------------------------------------------------------------
	public boolean isHigherThan(CardOld card2)
	{
