...
public abstract class ArrayList<T> implements ListADT<T>, Iterable<T> {
	 ...
	 * capacity of the old one. Called by descendant classes that add elements to
	 * the list.
	 */
	...
	public T removeLast() throws EmptyCollectionException {
		// To be completed as a Programming Project
		if (this.size() == 0) {
			throw new EmptyCollectionException("empty list error");
		}
		T toRemove = this.list[rear - 1];
		rear--;
		return toRemove; // temp
	}
	...
	public T removeFirst() throws EmptyCollectionException {
		...
		T toRemove = this.list[0];
		for (int index = 1; index < rear; index++) {
	...
	/**
	 * Returns a reference to the element at the front of this list. The element is
	...
	public T first() throws EmptyCollectionException {
		...
		if (this.size() == 0) {
			...
			return this.list[0]; // temp
	}

	/**
	 * Returns a reference to the element at the rear of this list. The element is
	 * not removed from the list. Throws an EmptyCollectionException if the list is
	 * empty.
	 *
