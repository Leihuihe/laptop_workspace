...
public class RationalNumber implements Comparable<RationalNumber>
{
	...
	{
		RationalNumber[] bagOfFractions = new RationalNumber[210];
		int nextPos = 0;
	...
	public boolean equals(Object obj)
	{
		...
		RationalNumber rnum = (RationalNumber) obj;
		// check if this is "equals" to obj
		if(this.numerator*rnum.getDenominator()==this.denominator*rnum.getNumerator())
			return true;
		else
			return false;
	}
	...
	public int compareTo(RationalNumber rNum)
	{
		...
		if (Math.abs(thisValue-rNumValue) < 0.0001)
		{
