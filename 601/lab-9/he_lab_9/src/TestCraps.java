...
public class TestCraps
{
	...
	public TestCraps()
	{
		...
		// use the comments below to change the Die objects used in the play

		 game = new CrapsGame(new CrookedDie1(), new FairDie());

		// the above substitutes subclass objects for Die,
	...
	public void reportStats()
	{
		...
		StdOut.println("Longest game was " + end + " moves.");
	...
	public static void main(String[] args)
	{
		...
		test.play(NUM_TO_PLAY); // NUM_TO_PLAY); // play games of craps
