...
public class Dice
{
	...
	public Dice()
	{
		...
		this.die1 = new FairDie();
		this.die2 = new FairDie();
		this.roll();
	}

	public Dice(Rollable die1, Rollable die2) // overloaded constructor
	{
		this.die1 = die1;
		this.die2 = die2;
	}
	...
	//
	// die1: 4 + die2: 3 => roll of 7
	//

	public String toString()
	{
		return "Dice: " + die1.getLastRoll() + ", " + die2.getLastRoll();
	}
